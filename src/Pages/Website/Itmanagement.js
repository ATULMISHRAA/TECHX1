  ...
  return (
           ...
           <div className="row ">
               <div className="col-lg-6">
                    <div className="image-aboutus-section">
                       <img
                         src={baseUrl + "/icons/Ai-robot2.png"}
                          className=" img-fluid"
                          alt="Image"
                       />
                    </div>
                ...
                <div className="col-lg-6">
                    <div className="aboutus-text-section">
                        <h2 className="AI-text-title-one white-theme-text-AI color-about mt-1" style={{fontSize:40}}>
        ...
        <div className="se-iv-home py-90 bg-2">
            <div className="container">
             ...
             <div className="se-head" data-aos="fade-down">
               <h3 className="se-title-1" data-aos="fade-left">Navigating Tomorrow's Tech Landscape Today</h3>
               <p className="se-title-2" data-aos="fade-right">
             ...
             <div className="col-xl-4 col-lg-4 col-md-6 mb-2">
                ...
                <div className="box color-3">
                   {/* <!-- link --> */}
                    ...
                    {/* <!-- box-title --> */}
                    <h3 className="box-title" data-aos="fade-down">Introduction</h3>
                    {/* <!-- box-para --> */}
               ...
               <div className="col-xl-4 col-lg-4 col-md-6 mb-2">
                   ...
                   <div className="box color-5">
                      ...
                      <div className="icon icon-style color3 m-auto">
                        ...
                        {/* <!-- box-title --> */}
                        <h4 className="box-title" data-aos="fade-right">Our Approach</h4>
                        {/* <!-- box-para --> */}
                        <p className="box-para" data-aos="fade-left">
                 ...
                 <a href="#" className="box-link"></a>
                  {/* <!-- icon --> */}
                   <div className="icon icon-style color3 m-auto">
                    ...
                    {/* <!-- box-title --> */}
                    <h4 className="box-title" data-aos="fade-right">Strategic Insight</h4>
                    {/* <!-- box-para --> */}
                    <p className="box-para" data-aos="fade-left">
      ...
      <div className="container-fluid pt-2 webhosting-all-section cloud-banner-section">
        <div className="row ">
          <div className="col-lg-6">
            <div className="image-aboutus-section">
              <img
                src={baseUrl + "/icons/Ai-robot3.png"}
                className=" img-fluid"
                alt="Image"
              />
            </div>
          ...
          <div className="col-lg-6">
            <div className="aboutus-text-section">
              <h1 className="sec-title-2 mt-1" data-aos="fade-left">
              Expertise Across Industries
              </h1>
              <br />
              <p className="sec-para-1 mb-1" data-aos="fade-left">
   ...
   <div className="container-fluid webhosting-all-section cloud-banner-section">
        <div className="row cloud-row-reverse">
          <div className="col-lg-6">
          <div className="aboutus-text-section">
             <h1 className="sec-title-2 mb-2" data-aos="fade-down">
                 Collaborative Partnership
             </h1>
              <p className="sec-para-1 mb-1" data-aos="fade-up">
          ...
          <div className="col-lg-6">
            ...
            <div className="image-aboutus-section">
              <img
                src={baseUrl + "/icons/Ai-robot.png"}
                className=" img-fluid"
                alt="Image"
                data-aos="fade-right" />
            </div>
